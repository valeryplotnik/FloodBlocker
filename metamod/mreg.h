...
class MRegCmdList : public class_metamod_new {
	...
	// functions:
		DLLINTERNAL MRegCmd * find(const char *findname);	// find by MRegCmd->name
		DLLINTERNAL MRegCmd * add(const char *addname);
...
class MRegCvarList : public class_metamod_new {
	...
	// functions:
		DLLINTERNAL MRegCvar * add(const char *addname);
		DLLINTERNAL MRegCvar * find(const char *findname);	// find by MRegCvar->data.name
		void DLLINTERNAL disable(int plugin_id);		// change status to Invalid
...
class MRegMsgList : public class_metamod_new {
	...
	// functions:
		DLLINTERNAL MRegMsg * add(const char *addname, int addmsgid, int addsize);
		DLLINTERNAL MRegMsg * find(const char *findname);
		DLLINTERNAL MRegMsg * find(int findmsgid);
